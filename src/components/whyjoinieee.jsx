    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid place-items-center lg:mx-0">
          <h2 className="text-lg font-semibold leading-8 tracking-tight text-cyan-900">Benefits</h2>
            ...
            {benefits.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  ...
                  <p className="mt-6">
                    <a href={feature.href} className="text-base font-semibold leading-7 text-cyan-600">
