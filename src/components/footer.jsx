const navigation = {
  ...
  company: [
    ...
    { name: "IEEE Job Site", href: "https://jobs.ieee.org/" },
    {
      ...
      href: "https://www.ieee.org/membership/products/google-apps.html",
    },
  ],
  legal: [
    { name: "Claim", href: "#" },
            ...
            <ul role="list" className="flex justify-start space-x-5">
              ...
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-[#CD201F]"
                >
              ...
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-[#cd486b]"
                >
              ...
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-[#00acee]"
                >
