        ...
        <div className="bg-gray-50">
          <div className="py-20">
            <div className="relative z-5 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 max-w-3xl text-xl text-gray-500 text-justify">
                For any inquiries, feedback or collaboration opportunities, we
                are here to listen and respond. Feel free to use the contact
                form provided below, and our friendly team will get back to you
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 my-6">
                ...
                <div className="relative overflow-hidden bg-gradient-to-b from-teal-500 to-teal-600 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  <p className="mt-6 max-w-3xl text-base text-teal-50">
                    If you have any inquiry about our student branch, let us
                    know.
                  </p>
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50">
                      ...
                      />
                      <span className="ml-3">
                        ieeeaiubstudentbranch@gmail.com
                      </span>
                    </dd>
                  </dl>
