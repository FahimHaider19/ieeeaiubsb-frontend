  ...
  return (
    ...
    <main className="overflow-hidden bg-gray-50">
      ...
      <div className="bg-gray-50">
        <div className="py-20">
          <div className="relative z-5 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
      ...
      <section className="relative bg-gray-50" aria-labelledby="contact-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="relative bg-white shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 my-6">
              {/* Contact information */}
              <div className="relative overflow-hidden bg-gradient-to-b from-teal-500 to-teal-600 py-10 px-6 sm:px-10 xl:p-12">
                ...
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-teal-50">
                    <MapPinIcon className="h-6 w-6 flex-shrink-0 text-teal-200" aria-hidden="true" />
                      <span className="ml-3">American International University-Bangladesh (AIUB). 408/1, Kuratoli, Khilkhet, Dhaka 1229, Bangladesh.</span>
                  </dd>
                  <dt>
                    <span className="sr-only">Phone number</span>
                  </dt>
                  <dd className="flex text-base text-teal-50">
                    ...
                    <span className="ml-3">+88​01705151681</span>
                  </dd>
                  <dt>
                  ...
                  <dd className="flex text-base text-teal-50">
                    ...
                    <span className="ml-3">ieeeaiubstudentbranch@gmail.com</span>
                  </dd>
                </dl>
                <ul role="list" className="mt-8 flex space-x-12">
                  <li>
                    <a className="text-teal-200 hover:text-teal-100" href="https://www.facebook.com/IEEEAIUBStudentBranch">
              ...
              <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                <h3 className="text-lg font-medium text-gray-500">Send us a message</h3>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        className="block w-full rounded-md border-gray-300 py-3 px-4 text-gray-500 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                      />
                    </div>
                  </div>
                  <div>
