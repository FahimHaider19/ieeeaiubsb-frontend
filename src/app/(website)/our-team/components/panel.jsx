      ...
      <div className="mt-6 grid grid-cols-1 justify-items-center gap-4 md:grid-cols-4 lg:mt-8">
        {committees.map((committee, index) => (
          ...
          >
            ...
            <h5 className="mb-2 text-2xl text-center font-bold tracking-tight text-gray-600 hover:text-gray-900">{committee.name} {props.year}</h5>
          </a>
        ))}
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 justify-items-center gap-4 md:grid-cols-4 lg:mt-8">
          ...
          {years.map((year) => (
            ...
            <div
              className="relative w-full flex items-center justify-center space-x-3 overflow-hidden rounded-lg border border-gray-300 bg-white px-auto py-5 shadow-sm hover:border-gray-400"
            >
              <div className="">
